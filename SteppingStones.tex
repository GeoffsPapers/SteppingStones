...
% Section~\ref{Languages} provides an overview of the TPTP languages,
% which are used for building the TPTP problem library described in Section~\ref{TPTP} and
% the TSTP solution library described in Section~\ref{TSTP}.
% The libraries use the SZS ontologies described in Section~\ref{SZS}, and the Specialist Problem
% Classes (SPCs) described in Section~\ref{SPCs}.
% The TSTP solution library and the SPCs provide the data for computing problem difficulty ratings,
% described in Section~\ref{Ratings}.
...
problem library.
A comprehensive library of test problems, in a simple, unambiguous, reference mechanism, is 
necessary for meaningful system evaluations, meaningful system comparisons, repeatability of 
...
prior years when step changes also perturbed the competition design).
...
\item Jeff Pelletier - Early support and thoughtful advice, problem contributions. % 2001
\item Stephan Schulz - Technical expertise.                                      % 1996
\item Andrei Voronkov and the Vampire Team - Enthusiasm and constructive feedback.  % 2000
\item Allen van Gelder - The TPTP language BNF and parser.                    % 2006
\item Adam Pease and Josef Urban - Large theory problems.                     % 2010
\item Christoph Benz{\"u}ller and Chad Brown - The TH0 language.              % 2010
\item Koen Claessen and Peter Baumgartner and Stephan Schulz - The TF0 language. % 2012
\item Jasmin Blanchette - Linking Sledgehammer to SystemOnTPTP, the TF1 language.     % 2013
\item Andrei Paskevich - The TF1 language.                                    % 2013
\item Cezary Kaliszyk and Florian Rabe - The TH1 language.                    % 2016
\item Evgeny Kotelnikov - The TXF language.                                   % 2018
\item Christoph Benz{\"u}ller and Alexander Steen - The NTF language.         % 2022
\end{packed_itemize}
Thank you!
